        ...
        <Card>
          ...
          <CardBody>
            <p>
              ...
              <br />
              <br />
              {'{buyer}'} authorizes this contract to transfer sufficient EOS tokens to buy the RAM based upon the
              current price as determined by the market maker algorithm.
              <br />
              <br />
              {'{buyer}'} accepts that a 0.5% fee will be charged on the EOS spent and that the actual RAM received may
              be slightly less than requested due to the approximations necessary to enable this service. {'{buyer}'}{' '}
              accepts that a 0.5% fee will be charged if and when they sell the RAM received. {'{buyer}'} accepts that
              ...
              {'{buyer}'} acknowledges that the price of RAM may increase or decrease over time according to supply and
              demand. {'{buyer}'} acknowledges that RAM is non-transferable. {'{buyer}'} acknowledges RAM currently in
              use by their account cannot be sold until it is freed and that freeing RAM may be subject to terms of
              other contracts.{' '}
            </p>
          </CardBody>
        </Card>
